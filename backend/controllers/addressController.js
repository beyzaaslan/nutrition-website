...
const createAddress = async (req, res) => {
    try {
        const {address_line1, address_line2, city, state, postal_code, country, is_primary, UserId} = req.body;
...
const updateAddress = async (req, res) => {
    try {
        ...
        const {address_line1, address_line2, city, state, postal_code, country, is_primary} = req.body;
